...
def getPrediction(img, model1, model2, callback):
...
########### Now patchify input image to size 512x512 ##########################
    ...
    for i in range(patches_img.shape[0]):
        for j in range(patches_img.shape[1]):
            ...
            tot = patches_img.shape[0]*patches_img.shape[1]
            ...
            pred1 = model1.predict(single_patch_img_processed, verbose=0)
            
            single_patch_img_processed =preprocess_input2(single_patch_img)
            pred2 = model2.predict(single_patch_img_processed, verbose=0)
            ...
            callback(current_progress/tot * 100)
    ...
    # pred_GYF=calcGYF(segmentedImg, area_bush_constant, area_grass_constant, area_newTree_constant, 
    #         area_treeBig_constant, area_treeMedium_constant, area_treeSmall_constant, 
    #         area_playGr_constant, area_social1_constant, area_social2_constant, 
    #         area_social3_constant, area_shadow_constant, area_cultiVland_constant, area_pergola_constant)
    # test_img_number=1
