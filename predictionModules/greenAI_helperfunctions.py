...
def calcGYF(segmentedImg, area_bush_constant = 0.55 , area_grass_constant = 1.5, area_newTree_constant =1.63, 
            area_treeBig_constant=1.8, area_treeMedium_constant=1.55, area_treeSmall_constant=1.3, 
            area_playGr_constant=1.2, area_social1_constant=1.2, area_social2_constant=1.2, 
            area_social3_constant=1.2, area_shadow_constant=1.0, area_cultiVland_constant=1.5, area_pergola_constant=0.3):
    ...
    area_total=np.sum(segmentedImg !=0)
    ...
    area_shadow=int((np.sum(segmentedImg == 13))*0.80) ## Take 60% of pixels in shadow class as grass
    ####
    ...
    print(area_bush_constant, area_grass_constant)


    ## Average valur for Bush can be 0.55 or 0.85
    area_ecoSurface = ((area_bush*area_bush_constant)+(area_grass*area_grass_constant)+(area_newTree*area_newTree_constant)
                       +(area_treeBig*area_treeBig_constant) +(area_treeMedium*area_treeMedium_constant)+(area_treeSmall*area_treeSmall_constant)
                       +(area_playGr*area_playGr_constant)+(area_social1*area_social1_constant)+(area_social2*area_social2_constant)
                       +(area_social3*area_social3_constant)+(area_shadow*area_shadow_constant) 
                        + (area_cultiVland*area_cultiVland_constant)+ (area_pergola*area_pergola_constant))
